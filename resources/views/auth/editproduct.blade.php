...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased  bg-[#e5e7eb]">
        <style></style>
  ...
  <div class="lg:flex">
    ...
    <div class="lg:flex lg:w-full">
      ...
      <div class="hidden lg:flex lg:flex-col transition-menu w-20" :class="{ 'w-2/6': isOpen}">
        ...
        <nav v-show="!isOpen" class="h-screen fixed bg-green-900 transition-menu">
...
@foreach($product->images as $image)
 ...
 <img height="200px" width="400px" src="{{ asset('storage/' . $image->image_url) }}" alt="Product Image">
@endforeach
</div>    
          <x-product-form 
    :action="route('prodcut.editproduct', $product->id)" 
    :method="'PUT'" 
