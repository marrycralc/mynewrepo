    ...
    <div class="lg:flex lg:w-full">
      ...
      <div class="w-full">
        ...
        <div>
          ...
          <x-product-form 
    :action="route('prodcut.add')" 
    :button-text="'Add new product'" 
   
    
/>

 <div class="w-full pl-8 mx-auto">
<!--- more free and premium Tailwind CSS components at https://tailwinduikit.com/ --->
            ...
            <div class="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10">
                ...
                <div class="mt-7 overflow-x-auto">
                    <table class="w-full whitespace-nowrap">
                        <tbody>
                            <tr class="text-left ">
                          <th  class="text-left p-5">Product name</th>
                          <th  class="text-left p-5">product description</th>
                          <th  class="text-left p-5">product price</th>
                          <th  class="text-left p-5">product Quatity</th>
    ...
    <tr tabindex="0" class="focus:outline-none h-16 border border-gray-100 rounded">
        ...
        <a href="/editproduct/{{$product->id}}">Edit </a>
            <div class="ml-5">
                <div class="bg-gray-200 rounded-sm w-5 h-5 flex flex-shrink-0 justify-center items-center relative">
                    <input placeholder="checkbox" name="edited" type="checkbox" class="focus:opacity-100 checkbox opacity-0 absolute cursor-pointer w-full h-full" />
        ...
        <td class="">
            <div class="flex items-center pl-5">
                <p class="text-base font-medium leading-none text-gray-700 mr-2"> {{ $product->prodcut_name }}</p>
        ...
        <td class="">
            <div class="flex items-center">
                ...
                <p class="text-sm leading-none text-gray-600 ml-2">{{ $product->descrioption }}</p>
            </div>
        </td>
        <td class="">
            <div class="flex items-center">
    ...
    @foreach($product->images as $image)
        ...
        <img height="50px" width="50px" src="{{ asset('storage/' . $image->image_url) }}" alt="Product Image">
    @endforeach
</div>
        ...
        <td class="">
            <div class="flex items-center">
                ...
                <form action="{{ route('product.deleteproduct', $product->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this product?');" style="display:inline;">
    @csrf
